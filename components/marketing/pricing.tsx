...
function CheckIcon({ muted = false }: { muted?: boolean }) {
  return (
    <svg
      ...
      viewBox="0 0 16 16"
      fill="none"
      className={`shrink-0 mt-0.5 ${muted ? "text-gray-400 dark:text-gray-500" : "text-emerald-500"}`}
    >
...
export function Pricing() {
  return (
    <section id="precos" className="bg-white dark:bg-gray-950 py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mx-auto grid max-w-4xl grid-cols-1 gap-6 md:grid-cols-2">
          {/* free */}
          <div className="flex flex-col rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900 p-8 shadow-sm">
            <div className="mb-6">
              <p className="text-sm font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Grátis</p>
              <div className="mt-3 flex items-end gap-1">
                <span className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white">R$&nbsp;0</span>
                <span className="mb-1 text-sm text-gray-400 dark:text-gray-500">/mês</span>
              </div>
              <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Para começar e validar o processo.</p>
            </div>
            ...
            <div className="mt-auto">
              <Link
                href="/register"
                className="block w-full rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 py-3 text-center text-sm font-semibold text-gray-800 dark:text-gray-200 transition-all hover:border-gray-300 dark:hover:border-white/20 hover:bg-gray-100 dark:hover:bg-white/10 hover:shadow-sm active:scale-95"
              >
                Começar grátis
              </Link>
            </div>
          ...
          <div className="relative flex flex-col rounded-2xl border-2 border-blue-600 bg-blue-600 p-8 shadow-xl shadow-blue-600/20 overflow-visible">
            ...
            <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-600 border-2 border-white dark:border-gray-950 px-3 py-1 text-xs font-bold text-white shadow-sm">
        ...
        <p className="mt-10 text-center text-sm text-gray-400 dark:text-gray-500">
          ...
          <a href="mailto:contato@pipeflow.com.br" className="font-medium text-blue-600 dark:text-blue-400 hover:underline">
            Fale com a gente
          </a>
        </p>
      </div>
