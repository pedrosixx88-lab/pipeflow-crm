const FEATURES = [
  {
    ...
    description:
      "Board visual com drag-and-drop entre etapas. Veja o status de cada negócio em tempo real e mova deals com um clique.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    description:
      "Cadastre, filtre e acompanhe cada lead com histórico completo. Busca instantânea e filtros por status para encontrar qualquer contato.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    description:
      "KPIs em tempo real: valor do pipeline, taxa de conversão, negócios por etapa. Gráfico de funil para identificar gargalos rapidamente.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    title: "Multi-empresa",
    description:
      "Gerencie múltiplos workspaces em uma única conta. Convide seu time, defina papéis de admin ou membro e colabore sem conflitos.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    description:
      "Registre ligações, e-mails, reuniões e notas em cada lead. Timeline cronológica para nunca perder o contexto de uma conversa.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    description:
      "Web app responsivo que funciona em desktop, tablet e mobile. Seus dados sincronizados em tempo real, de qualquer dispositivo.",
  },
];
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map((f) => (
            <div
              key={f.title}
              className="group rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-gray-300 hover:shadow-md hover:-translate-y-0.5"
            >
