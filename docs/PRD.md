# PipeFlow CRM — Product Requirements Document (PRD)
...
### Busca e Filtros
- Busca global por leads, negócios e contatos
- Filtros por status, responsável, data, etapa do pipeline

### Onboarding do Usuário
- Fluxo guiado após cadastro: criar workspace → convidar time → cadastrar primeiro lead
...
- Quebrar o build em milestones lógicos e incrementais
